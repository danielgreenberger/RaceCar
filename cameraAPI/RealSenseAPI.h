...
public:
        ...
        /*
            Streams represent the different types of data outputs which the RealSense device can provide. 
            
            As the name suggests, each stream provides the data in a constant rate of frames, 
            where each frame is a single data unit (such as
...
//        };
       ...
       /*=======================================================
       * @brief           Connect to a RealSense device
       *
       * @description     This function binds the object to a specific RealSense device 
       *                  attached to the Jetson system.  
       *                  Note: This function assumes that only 1 device is connected to the Jetson.
       *
       * @param           None
       *
       * @return          True  - connection completed successfully,  
       *                  False - error while connecting 
       =========================================================*/
       bool connectCamera();
...
private:
      ...
      /* High level RealSense API */
        // Serves as wrapper mechanism for the low level API for basic configurations. 
        // For fine-tuning of the RealSense device the lower API may be used. 
      rs2::pipeline _pipe;
      rs2::pipeline_profile _pipe_profile;
      rs2::config _config;
     

      /* RealSense output buffer */
